...
export const scrapeRecentRelease = async ({
  list = [],
  page = 1,
  type = 1,
}) => {
...
export const scrapeAnimeList = async ({ list = [], page = 1 }) => {
  try {
    const AnimeList = await axios.get(
      `${BASE_URL}/anime-list.html?page=${page}`
    );
...
export const scrapeAnimeAZ = async ({ list = [], aph, page = 1 }) => {
  try {
    const AnimeAZ = await axios.get(
      `${BASE_URL}/anime-list-${aph}?page=${page}`
    );
...
export const scrapeOngoingAnime = async ({ list = [], page = 1 }) => {
  try {
    const OngoingAnime = await axios.get(
      `${BASE_URL}/ongoing-anime.html?page=${page}`
    );
...
export const scrapeCompletedAnime = async ({ list = [], page = 1 }) => {
  try {
    const CompletedAnime = await axios.get(
      `${BASE_URL}/completed-anime.html?page=${page}`
    );
      ...
      while (hasMore) {
        ...
        $("div.added_series_body.popular > ul > li").each((i, el) => {
          ...
          list.push({
            ...
            animeUrl:
              BASE_URL + "/" + $(el).find("a:nth-child(1)").attr("href"),
            genres: genres,
          });
        });
        pageNum++;
...
export const scrapeWatchAnime = async ({ id }) => {
  try {
    ...
    const anime_category = $("div.anime-info a")
      .attr("href")
      .replace("/category/", "");
    const episode_page = $("ul#episode_page").html();
    const movie_id = $("#movie_id").attr("value");
...
export const scrapeCompletedPage = async ({ page }) => {
  try {
    const CompletedPage = await axios.get(
      `${BASE_URL}/completed-anime.html?page=${page}`
    );
...
export const scrapeOngoingPage = async ({ page }) => {
  try {
    const OngoingPage = await axios.get(
      `${BASE_URL}/ongoing-anime.html?page=${page}`
    );
...
export const scrapeMoviePage = async ({ page }) => {
  try {
    const MoviePage = await axios.get(
...
export const scrapeSubCategoryPage = async ({ subCategory, page }) => {
  try {
    const SubCategoryPage = await axios.get(
      `${BASE_URL}/sub-category/${subCategory}?page=${page}`
    );
...
export const scrapeRecentPage = async ({ page, type }) => {
  try {
    const RecentPage = await axios.get(
      `${recent_release_url}?page=${page}&type=${type}`
    );
...
export const scrapeNewSeasonPage = async ({ page }) => {
  try {
    const NewSeasonPage = await axios.get(
...
export const scrapeAnimeListPage = async ({ page }) => {
  try {
    const AnimeListPage = await axios.get(
      `${BASE_URL}/anime-list.html?page=${page}`
    );
...
export const scrapeAnimeAZPage = async ({ aph, page = 1 }) => {
  try {
    const AnimeAZPage = await axios.get(
      `${BASE_URL}/anime-list-${aph}?page=${page}`
    );
